define("./workbox-8778d57b.js", ["exports"], function (t) {
  ...
  class a {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      let a = r && r.handler;
      const o = t.method;
      if ((!a && this.s.has(o) && (a = this.s.get(o)), !a)) return;
      let c;
      try {
      ...
      return (
        c instanceof Promise &&
          this.i &&
          (c = c.catch((n) => this.i.handle({ url: s, request: t, event: e }))),
        c
      );
    }
  ...
  class v {
    constructor(t, e = {}) {
      (this.q = !1),
        ...
        (this.N = e.matchOptions),
        (this.g = t),
        (this.C = new R(t));
    }
    async expireEntries() {
      if (this.q) return void (this.U = !0);
      this.q = !0;
      const t = this.L ? Date.now() - 1e3 * this.L : 0,
        e = await this.C.expireEntries(t, this._),
        s = await self.caches.open(this.g);
      for (const t of e) await s.delete(t, this.N);
      (this.q = !1), this.U && ((this.U = !1), d(this.expireEntries()));
    }
    async updateTimestamp(t) {
      await this.C.setTimestamp(t, Date.now());
    }
    async isURLExpired(t) {
      if (this.L) {
        return (await this.C.getTimestamp(t)) < Date.now() - 1e3 * this.L;
      }
      return !1;
    }
    async delete() {
      (this.U = !1), await this.C.expireEntries(1 / 0);
    }
  }
  try {
  ...
  class N {
    constructor(t, e) {
      (this.T = {}),
        ...
        (this.K = [...t.plugins]),
        (this.O = new Map());
      for (const t of this.K) this.O.set(t, {});
      ...
      return this.waitUntil(
        (async () => {
          ...
          try {
            ...
            t = await fetch(
              n,
              "navigate" === n.mode ? void 0 : this.D.fetchOptions
            );
    ...
    cacheMatch(t) {
      return this.waitUntil(
        (async () => {
          const e = b(t);
          let s;
          const { cacheName: n, matchOptions: i } = this.D,
    ...
    async cachePut(t, e) {
      ...
      if (!o) return;
      const { cacheName: c, matchOptions: h } = this.D,
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const r = U({}, n, { ignoreSearch: !0 }),
                a = await t.keys(e, r);
              for (const e of a) if (i === x(e.url, s)) return t.match(e, n);
    ...
    hasCallback(t) {
      for (const e of this.D.plugins) if (t in e) return !0;
      return !1;
    }
  ...
  class C {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        i = new N(this, { event: e, request: s, params: n }),
        r = this.W(i, s, e);
      return [r, this.A(r, i, s, e)];
    }
    async W(t, e, n) {
      await t.runCallbacks("handlerWillStart", { event: n, request: e });
      let i = void 0;
      try {
        if (((i = await this.S(e, t)), !i || "error" === i.type))
  ...
  class P {
    constructor({ precacheController: t }) {
      (this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
        const s = (e && e.cacheKey) || this.I.getCacheKeyForURL(t.url);
  ...
  const O = {
    cacheWillUpdate: async ({ response: t }) => (t.redirected ? await K(t) : t),
  };
  class M extends C {
    constructor(t = {}) {
    ...
    async B(t, e) {
      ...
      let i = Boolean(n);
      if ((n && n.status >= 400 && !this.H() && (i = !1), !i))
    ...
    H() {
      return this.plugins.some((t) => t.cacheWillUpdate && t !== O);
    }
  }
  class W {
    constructor({
    ...
    createHandlerBoundToURL(t) {
      ...
      return (s) => (
        ...
        (s.params = U({ cacheKey: e }, s.params)),
  ...
  (t.CacheFirst = class extends C {
    ...
    (t.ExpirationPlugin = class {
      ...
      Y(t) {
        ...
        let e = this.tt.get(t);
        return e || ((e = new v(t, this.Z)), this.tt.set(t, e)), e;
      }
      X(t) {
        if (!this.L) return !0;
        const e = this.et(t);
    ...
    (t.NetworkFirst = class extends C {
      constructor(t = {}) {
        super(t),
          this.plugins.some((t) => "cacheWillUpdate" in t) ||
            this.plugins.unshift(q),
          (this.st = t.networkTimeoutSeconds || 0);
      }
      async S(t, e) {
        const n = [],
          i = [];
        ...
        const a = this.it({ timeoutId: r, request: t, logs: n, handler: e });
        i.push(a);
    ...
    (t.StaleWhileRevalidate = class extends C {
      constructor(t) {
        super(t),
          this.plugins.some((t) => "cacheWillUpdate" in t) ||
            this.plugins.unshift(q);
