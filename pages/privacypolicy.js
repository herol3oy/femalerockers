...
export default function privacypolicy() {
  ...
  return (
    <div className="container my-3 text-light">
      <h5 className="text-danger">Privacy Policy for Female Rockers Blog</h5>
      <p>
        At Female Rockers Blog, accessible from femalerockers.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Female Rockers Blog and how we use it. If you have additional questions
        ...
        that they shared and/or collect in Female Rockers Blog. This policy is
      ...
      <h6>Log Files</h6>
      <p>
        Female Rockers Blog follows a standard procedure of using log files.
        ...
        Policy Generator and the Disclaimer Generator.
      </p>
      <h6>Cookies and Web Beacons</h6>
      <p>
        Like any other website, Female Rockers Blog uses 'cookies'. These
        ...
        information. For more general information on cookies, please read "What
        Are Cookies".
      </p>
      ...
      <p>
        ...
        advertising partners of Female Rockers Blog. Third-party ad servers or
        ad networks use technologies like cookies, JavaScript, or Web Beacons
        that are used in their respective advertisements and links that appear
        on Female Rockers Blog, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that Female Rockers Blog has no access to
        or control over these cookies that are used by third-party advertisers.
      </p>
      <h6>Third Party Privacy Policies</h6>
      <p>
        Female Rockers Blog's Privacy Policy does not apply to other advertisers
      ...
      <p>
        ...
        participate in, and/or monitor and guide their online activity. Female
        Rockers Blog does not knowingly collect any Personal Identifiable
